...
describe Outpost::VisualCampaignsController do
  ...
  describe 'create' do
    context 'valid record' do
      before do
        post :create, visual_campaign: build(:visual_campaign).attributes.slice(
          *%w(title output_key markup starts_at ends_at domains))
      end
  ...
  describe 'update' do
    ...
    context 'valid record' do
      it "updates the object" do
        put :update, id: campaign.id, visual_campaign: {
          :title => "Testing 123"
        }
